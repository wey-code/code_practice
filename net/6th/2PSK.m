...
figure;
plot(x,A1); ylim([-0.2 1.2]);title('原始二进制波形')%原二进制
figure;
subplot(7,1,1);plot(x,A2); ylim([-1.5 1.5]);title('原始二进制双极性波形')%双极性
...
subplot(7,1,7);plot(x,sov3); ylim([-1.5 1.5]);title('经采样判决恢复出的双极性波形')%
